...
#! nix-shell -i python -p python3.pkgs.joblib python3.pkgs.click python3.pkgs.click-log nix nurl yarn-berry_4-fetcher.yarn-berry-fetcher nix-prefetch-git prefetch-npm-deps gclient2nix
"""
electron updater
...
def get_electron_yarn_hash(electron_tag: str) -> str:
    print(f"yarn-berry-fetcher", file=sys.stderr)
